...
\caption{This visualisation shall illustrate the image recognition process which is performed by the Google Cloud Vision API. The image source\protect\footnote{https://allaboutlimassol.com/assets/images/primary-image/51024-0.downhill\_mountain\_biking.jpg, accessed: 29.03.2019} was altered by the author.}
...
\begin{wrapfigure}{r}{0.6\textwidth}
   \centering
   \begin{minipage}{\textwith}
   \renewcommand{\thempfootnote}{\arabic{mpfootnote}}
   \includegraphics[width=0.59\textwidth]{img/over_underfitting}
   \caption{Visualisation of under- and overfitting on a dataset. The image source\footnote{https://medium.com/greyatom/what-is-underfitting-and-overfitting-in-machine-learning-and-how-to-deal-with-it-6803a989c76, accessed: 29.03.2019} was altered by the author.}
...
%if trimming and clip is necessary: \includegraphics[trim={5cm 0 0 0},clip]{example-image-a}
  %\end{center}
  \caption{Visualisation of possible SMV fitted hyperplanes to separate two data-point clusters. H\textsubscript{3} does not manage to completely separate the clusters. H\textsubscript{1} does separate them entirely but violates the constraint to maximise the space between them, unlike H\textsubscript{2}. Image source: https://en.wikipedia.org/wiki/Linear\_classifier, accessed: 29.03.2019}
...
%if trimming and clip is necessary: \includegraphics[trim={5cm 0 0 0},clip]{example-image-a}
  %\end{center}
  \caption{Confusion matrix with \textit{n} classes. When considering the class k (0 $\le$ k $\le$ n), the four different classification results can be obtained: true positive (green), true negative (orange), false positive (brown), and false negative (red). The image source\footnotemark was altered by the author.}
  \label{fig:confusion_matrix_illustration}
\end{wrapfigure}
\footnotetext{Frank Kr\"uger, https://www.researchgate.net/figure/Confusion-matrix-for-multi-class-classification-The-confusion-matrix-of-a\_fig7\_314116591, accessed: 29.03.2019}
