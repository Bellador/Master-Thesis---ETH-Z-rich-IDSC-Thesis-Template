...
Additional location related information (address and location type) was gathered for all the media objects via the \textit{Google Geocoding} API. More information can be found in section \ref{geocoding_api}
