...
\title{Using a model trained on text and image-data to predict and map leisure activities in social media content.}
...
\supervision{Dr. Flurina Wartmann (WSL)\\ Prof. Dr. Ross Purves (UZH)\\ Dr. Rahul Deb Das (UZH)}
