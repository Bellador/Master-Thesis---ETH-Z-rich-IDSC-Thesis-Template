...
\title{Using a model trained on text and image data from social media content to predict and map leisure activities}
...
\supervision{Dr. Flurina Wartmann, Swiss Federal Research Institute for Forest, Snow and Landscape WSL\\ Prof. Dr. Ross Purves, Geography Department, University of Zurich UZH\\ Dr. Rahul Deb Das, Geography Department, University of Zurich UZH}
...
\cleardoublepage
\input{chapters/material_method}
...
%\cleardoublepage
% ...
\input{chapters/used_software}

\input{chapters/enclosed_CD_content.tex}
...
\printbibliography
\input{chapters/declaration_originality.tex}
