...
\usepackage[backend=biber, citestyle=authoryear-comp,sortcites=true,block=none ,indexing=false, citereset=none,isbn=true,url=true,doi=false ,natbib=true]{biblatex}
